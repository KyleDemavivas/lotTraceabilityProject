...
<head>
    ...
    <link rel="stylesheet" href="css/micro_process.css">
</head>
        ...
        <div class="modal-content">
            ...
            <form id="nogoodForm" method="POST">
                <div class="column">
                    ...
                    <div class="form-group">
                        <label for="scrap_micro" class="form-label">Scrap:</label>
                        <select class="form-input" id="modal_scrap_micro" name="scrap_micro" required>
                            <option value=""></option>
        ...
        $(document).ready(function() {
                    ...
                    serialDebounceTimer = setTimeout(() => {
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                if (!(response.success) && (response.errorcode == 'onhold')) {
                                    Swal.fire({
                                        icon: 'warning',
                                        title: 'Serial Code on Hold',
                                        text: response.message || 'This Serial Code is currently on hold.',
                                ...
                                if (response.success) {
                                    ...
                                    Swal.fire({
                                        ...
                                        text: response.message || 'This Serial Code Already Exists.',
                                        confirmButtonText: 'OK',
                                        allowOutsideClick: false,
                                        didOpen: () => {
            ...
            $('#modal_serial_code').on('input', function() {
                ...
                if (serial.length > 3) {
                    serialDebounceTimer = setTimeout(() => {
                        $.ajax({
                            url: 'micro_validateserialmatch.php',
                            type: 'POST',
                            dataType: 'json',
                            data: {
                                serial_code: serial,
