...
if (
    isset($_POST['qr_code'], $_POST['serial_code'], $_POST['defect'], $_POST['location'], $_POST['board_number'], $_POST['scrap_mod1'], $_POST['repairable'], $_POST['action_mod1'], $_POST['tenboard'])
) {
    try {
