...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        $updateSql = "UPDATE ai_process SET judgement_ll = 'HOLD'WHERE qr_code = :qr_code AND serial_code = :serial_code AND judgement_ll = 'NO GOOD'";
        ...
        $response['message'] = 'Previous NO GOOD set to HOLD, new repair inserted as PENDING.';
