...
try {
    $sql = "SELECT * FROM ai_process WHERE judgement_ll = 'NO GOOD' ORDER BY created_at DESC";
...
<head>
    <meta charset="UTF-8">
    <link rel="stylesheet" href="css/ai_ngverification.css">
...
<body>
    ...
    <script>
        ...
        document.getElementById('repairForm').addEventListener('submit', function(e) {
            ...
            fetch('ai_ngverificationsubmit.php', {
                    method: 'POST',
                    body: formData
                })
