...
try {
    $sql = "SELECT * FROM ai_process WHERE judgement_ll = 'PENDING' ORDER BY created_at DESC";
...
<body>
    <div class="container">
        <h2>LL AI Repair Verification</h2>
        ...
        <div class="modal-content">
            ...
            <form id="repairForm" class="form-container">
                ...
                <div class="form-group">
                    ...
                    <input class="form-input" type="text" name="verified_ll" id="verified_ll" required autocomplete="off">
                </div>
    ...
    <script>
        ...
        document.getElementById('repairForm').addEventListener('submit', function(e) {
            ...
            fetch('ai_verifyrepairLLsubmit.php', {
                    method: 'POST',
                    body: formData
                })
