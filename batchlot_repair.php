                ...
                <tbody>
                    <?php if (count($nogood_data) > 0): ?>
                        <?php foreach ($nogood_data as $row): ?>
                            <?php if ($row['batchlot'] === 'NO') continue; ?>
        ...
        <div class="modal-content">
            ...
            <form id="repairForm" class="form-container">
                ...
                <div class="form-group">
                    ...
                    <input class="form-input" type="text" name="verified_ll" id="verified_ll" value="<?= htmlspecialchars($_SESSION['user_namefl']) ?>" required autocomplete="off" readonly>
                </div>
