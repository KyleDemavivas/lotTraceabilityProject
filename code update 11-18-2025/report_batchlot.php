...
<body>
    <div class="container">
        ...
        <div class="repair-section">
            ...
            if (!$smt_repairs && !$ai_repair && !$handwork_repair): ?>
            ...
            <?php else: ?>
                ...
                <div class="table-container">
                    ...
                    <table>
                        ...
                        <?php if (!empty($smt_repairs)): ?>
                            <?php foreach ($smt_repairs as $row): ?>
                                <tr>
                                    ...
                                    <td><?= htmlspecialchars($row['verified_vi']) ?></td>
                                    <td><?= date("d-M g:i a", strtotime($row['created_at'])) ?></td>
                                </tr>
                            <?php endforeach; ?>
                        <?php else: ?>
                            <tr>
                ...
                <div class="table-container">
                    ...
                    <table>
                        ...
                        <?php if ($handwork_repair): ?>
                            <tr>
                                <td><?= htmlspecialchars($handwork_repair['defect']) ?></td>
                                <td><?= htmlspecialchars($handwork_repair['location']) ?></td>
                                <td><?= htmlspecialchars($handwork_repair['board_number']) ?></td>
                                <td><?= htmlspecialchars($handwork_repair['action_rp']) ?></td>
                                <td><?= htmlspecialchars($handwork_repair['operator_name']) ?></td>
                                <td><?= htmlspecialchars($handwork_repair['repaired_by']) ?></td>
                                <td><?= htmlspecialchars($handwork_repair['verified_ll']) ?></td>
                                <td><?= htmlspecialchars($handwork_repair['verified_vi']) ?></td>
                                <td><?= date("d-M g:i a", strtotime($handwork_repair['created_at'])) ?></td>
                            </tr>
                        <?php else: ?>
                            <tr>
                                <td colspan="9" style="text-align:center; color:red; font-weight:bold;">
