...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    try {
        ...
        $sql = "INSERT INTO repair_process (qr_code, model_name, assy_code, kepi_lot, serial_code, operator_name, repaired_by, action_rp, lcr_reading, parts_code, parts_lot, unitmeasurement, batchlot, repairable, shift, line, defect, location, board_number, repair_status, judgement_ll, created_at) 
        ...
        // $updateSql = "UPDATE vi_process SET serial_status = 'ONGOING REPAIR' WHERE qr_code = :qr_code AND serial_code = :serial_code AND serial_status != 'ONGOING REPAIR'";
