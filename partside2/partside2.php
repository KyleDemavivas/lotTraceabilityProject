        ...
        <form method="POST">
            ...
            <div class="form-section">
                <div class="form-group">
                    ...
                    <input type="text" class="form-input" name="serial_code" id="serial_code" autofocus autocomplete="off" minlength="12" maxlength="12" required>
                </div>
