...
try {
    $sql = "SELECT * FROM repair_process WHERE judgement_vi = 'PENDING' ORDER BY created_at DESC";
...
<body>
                    ...
                    <?php if (count($nogood_data) > 0) { ?>
                        <?php foreach ($nogood_data as $row) { ?>
                            <tr>
                                ...
                                <td><?php echo htmlspecialchars($row['repair_status']); ?></td>
                                <td><?php echo htmlspecialchars($row['judgement_ll']); ?></td>
                                <td><?php echo htmlspecialchars($row['line']); ?></td>
                                <td><?php echo htmlspecialchars($row['shift']); ?></td>
                        <!--Calls opedmodal function in JQuery and assigns data to the 'data' array with the $row variable that pulls from the database-->
    ...
    <div id="actionModal" class="modal">
        <div class="modal-content">
            ...
            <form id="repairForm" class="form-container">
                ...
                <div class="form-group">
                    <label class="form-label">LL Judgement</label>
                    <input class="form-input" type="text" name="judgement_ll" id="judgement_ll" readonly>
                </div>
                ...
                <div class="form-group">
                    <label class="form-label">VI Judgement</label>
                    <select class="form-input" name="judgement_vi" required autocomplete="off">
                ...
                <div class="form-group">
                    <label class="form-label">VI Verified by</label>
                    <input class="form-input" type="text" name="verified_vi" id="verified_vi" required autocomplete="off">
                </div>
    ...
    <script>
        ...
        //auto populate fields with data from table
        function openModal(data) {
            ...
            document.getElementById('judgement_ll').value = data.judgement_ll;
