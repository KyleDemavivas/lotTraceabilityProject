...
try {
    $sql = "SELECT * FROM repair_ll_verify ORDER BY created_at DESC";
                ...
                <tbody>
                    <?php if (count($nogood_data) > 0): ?>
                        <?php foreach ($nogood_data as $row): ?>
                            <?php if ($row['batchlot'] === 'YES') continue; ?>
        ...
        <div class="modal-content">
            ...
            <form id="repairForm" class="form-container">
                ...
                <div class="form-group">
                    ...
                    <input class="form-input" type="text" name="verified_ll" id="verified_ll" value=<?= htmlspecialchars($_SESSION['user_namefl']) ?> readonly>
                </div>
