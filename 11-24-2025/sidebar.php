...
<body>
    <div class="sidebar" id="sidebar">
        ...
        <ul class="menu">
            ...
            <li class="<?= ($current_page == 'manual_insertion.php') ? 'active' : '' ?>">
                <a href="manual_insertion.php"><i class="fas fa-handshake-angle"></i> <span>Manual Insertion</span></a>
            </li>

            <li class="<?= ($current_page == 'mod1.php') ? 'active' : '' ?>">
                <a href="mod1.php"><i class="fas fa-handshake-angle"></i> <span>MOD 1</span></a>
            </li>

            <li class="<?= ($current_page == 'mod2.php') ? 'active' : '' ?>">
                <a href="mod2.php"><i class="fas fa-handshake-angle"></i> <span>MOD 2</span></a>
            </li>
