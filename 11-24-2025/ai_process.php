    ...
    <script>
            ...
            if (
                ...
                if (verifyAssy === "" || assy === "") {
                    Swal.fire({
                        icon: 'warning',
                        title: 'Missing Data',
                        text: 'Both Verify Assy No. and Assy No. are required.'
                    });
                    return;
                }
                if (verifyAssy !== assy) {
                    Swal.fire({
                        icon: 'error',
                        title: 'Mismatch',
                        text: 'The Verify Assy No. does not match the Assy No. from QR Code.'
                    });
                    return;
                }
        ...
        $(document).ready(function() {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response.success) {
                                ...
                                $('input[name="assy_code"], input[name="model_name"], input[name="kepi_lot"], input[name="line"], input[name="shift"], input[name="qty_input"], input[name="final_qtyinput"]').val('');
                            }
                        }
                    });
                }
            ...
            $('form').submit(function(e) {
                ...
                const verifyAssy = $('input[name="verify_assy_code"]').first().val().trim();
                const qrAssy = $('input[name="assy_code"]').last().val().trim();
                            ...
                            Swal.fire({
                                ...
                                if (result.isConfirmed) {
                                    ...
                                    Swal.fire({
                                        ...
                                        title: 'Saved!',
                                        text: response.message, // dynamic message
                                        toast: true,
                                        position: 'top-right',
                                        timer: 3000,
