            ...
            <form id="nogoodForm" method="POST">
                <div class="column">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-input" name="action_mod1" id="action_mod1" required autocomplete="off">
                    </div>
                </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#nogoodForm').submit(function(e) {
                ...
                formData.append('scrap_mod1', $('#scrap_mod1').val());
            ...
            $('#serial_code').on('input', function() {
                ...
                if (serialcode.length > 3 && qrcode) {
                    ...
                    serialdebouncetimer = settimeout(() => {
                        $.ajax({
                            url: 'mod1_validateserialmatch.php',
                            type: 'post',
                            data: {
