            ...
            <form id="nogoodForm" method="POST">
                <div class="column">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-input" name="scrap_mod2" required>
                            <option value=""></option>
                    ...
                    <div class="form-group">
                        <label for="action_mod2" class="form-label">Action:</label>
                        <input type="text" class="form-input" name="action_mod2" id="action_mod2" required autocomplete="off">
                    </div>
                </div>
