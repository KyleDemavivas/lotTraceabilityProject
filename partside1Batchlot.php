...
<body>
    <div class="form-container">
        <form method="POST" id="mainForm" name="mainForm">
            <h1>
                <center>Part Side 1 Batchlot</center>
            </h1>
        ...
        $(document).ready(function() {
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                if (response.success) {
                                    ...
                                    $.ajax({
                                        url: 'get_boardcountPartside.php',
                                        type: 'POST',
                                        dataType: 'json',
                                        data: {
                                            kepi_lot: kepi_lot,
            ...
            $('#modal_serial_code').on('input', function() {
                ...
                if (serial.length > 3) {
                    serialDebounceTimer = setTimeout(() => {
                        $.ajax({
                            url: 'partside_validateserialmatch.php',
                            type: 'POST',
                            dataType: 'json',
                            data: {
                                serial_code: serial,
            ...
            $('#scrapButton').on('click', function(e) {
                ...
                getBoardData(serial_code, 'fetch_partside.php', function(response) {
                    if (response.success === true) {

                    const scrapData = buildScrapData(qr_code, serial_code, response, location, defect, "PARTSIDE 1 BATCHLOT", board_number);
