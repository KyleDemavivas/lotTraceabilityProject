...
<div class="hourly-output">
    <h4><strong><?php echo htmlspecialchars($line); ?></strong> Hourly Output <br><?php echo $shiftLabel; ?></h4>
...
foreach ($hourlyData as $hour => $qty) {
    ...
    ?>
                    <tr>
                        ...
                        <td><?php echo $qty > 0 ? $qty : 'No Production'; ?></td>
                    </tr>
                <?php } ?>
            </tbody>
            <tfoot>
                <tr class="total-row">
                    <td>Total</td>
                    <td><?php echo $totalQty > 0 ? $totalQty : 'No Production'; ?></td>
                </tr>
            </tfoot>
        </table>
    </div>
