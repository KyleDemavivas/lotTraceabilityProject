...
<head>
    ...
    <link rel="stylesheet" href="css/wi_process.css">
</head>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#nogoodForm').submit(function(e) {
                ...
                formData.append('scrap_wi', $('#modal_scrap_wi').val());
            ...
            $('#modal_serial_code').on('input', function() {
                ...
                if (serial.length > 3) {
                    serialDebounceTimer = setTimeout(() => {
                        $.ajax({
                            url: 'wi_validateserialmatch.php',
                            type: 'POST',
                            dataType: 'json',
                            data: {
                                serial_code: serial,
            ...
            $('#scrapButton').on('click', function(e) {
                ...
                getBoardData(serial_code, 'fetch_wi.php', function(response) {
                    if (response.success === true) {

                    const scrapData = buildScrapData(qr_code, serial_code, response, location, defect, "WI BATCHLOT", board_number);
